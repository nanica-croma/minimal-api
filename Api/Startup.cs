...
using minimal_api.Infraestruturas.Db;
    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints => {
                ...
                endpoints.MapPost("/administradores/login", ([FromBody] minimal_api.Dominio.DTOs.LoginDTO loginDTO, IAdministradorServico administradorServico) => {
                ...
                var validacao = new ErrosDeValidacao{
                    ...
                    return Results.Created($"/administradaor/{administrador.Id}", new AdministradorModelView{
                            Id = administrador.Id,
                            Email = administrador.Email,
                            Perfil = administrador.Perfil,
                        });
